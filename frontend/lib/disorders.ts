...
export function buildDisorderPopulateQuery(): string {
  const populate = [
    ...
    "overviewTab.contentSections.subsections.listItems.downloadFile",
    "overviewTab.contentSections.listItems",
    "overviewTab.contentSections.listItems.downloadFile",
    "overviewTab.faqSection",
    "overviewTab.faqSection.faqs",
    "personalStoriesTab",
    "personalStoriesTab.stories",
    "personalStoriesTab.stories.image",
    "personalStoriesTab.stories.image2",
    "personalStoriesTab.stories.image3",
    "resourcesTab",
...
export function buildRSSPopulateQuery(): string {
  ...
  populate.push(
    "overviewTab.emergencyGuide",
    "overviewTab.emergencyGuide.intro",
    "overviewTab.emergencyGuide.intro.bulletPoints",
    "overviewTab.emergencyGuide.sections",
    "overviewTab.emergencyGuide.sections.bulletPoints",
    "personalStoriesTab",
    "personalStoriesTab.stories",
    "personalStoriesTab.stories.image",
    "personalStoriesTab.stories.image2",
