...
export interface ApiRussellSilverSyndromeRussellSilverSyndrome
  ...
  info: {
    description: 'Main content for Russell Silver Syndrome page';
    displayName: 'Russell Silver Syndrome';
    pluralName: 'russell-silver-syndromes';
    singularName: 'russell-silver-syndrome';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::russell-silver-syndrome.russell-silver-syndrome'
    > &
      Schema.Attribute.Private;
    overviewTab: Schema.Attribute.Component<'rss.overview-tab', false>;
